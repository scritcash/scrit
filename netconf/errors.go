...
// ErrMintsOverlap is returned if the sets MintsAdded, MintsRemoved, and MintsReplaced overlap.
var ErrMintsOverlap = errors.New("netconf: the MintsAdded, MintsRemoved, and MintsReplaced sets overlap")
